...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/org/img/logo.png')}}">
    ...
    <script src="{{ asset('app-assets/js/select2.js') }}" type="text/javascript"></script>
...
@endif
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img
                            src="../../../app-assets/images/portrait/small/avatar-s-8.jpg" alt="png" height="32">
                    </div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img
                            src="../../../app-assets/images/portrait/small/avatar-s-1.jpg" alt="png" height="32">
                    </div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img
                            src="../../../app-assets/images/portrait/small/avatar-s-14.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img
                            src="../../../app-assets/images/portrait/small/avatar-s-6.jpg" alt="png" height="32">
                    </div>
                    <div class="search-data">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ url('/') }}" style="margin-top:0;">
                        <div class="brand-logo">
                            <img src="{{asset('assets/org/img/logo.png')}}" width="100" height="100">
                            {{-- <img src="{{ asset('app-assets/images/ico/logo_admin.png') }}"> --}}
                        </div>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="has-sub sidebar-group-active open">
                    ...
                    <ul class="menu-content custom_bullets">
                                ...
                                <li @if (request()->is('carousels/*')) class='active' @endif><a
                                        href="{{ url('/carousels/index') }}">
                                        {{-- <i class="feather icon-circle"></i> --}}
                                        <span class="menu-item " data-i18n="eCommerce">Carousel</span></a>
                                </li>
                                <li @if (request()->is('update/*')) class='active' @endif><a
                                        href="{{ route('update.index') }}">
                                        <span class="menu-item @if (request()->is('update/*')) 'active' @endif"
                                            data-i18n="eCommerce">Update</span></a>
                                </li>
